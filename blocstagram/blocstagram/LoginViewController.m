...
//  blocstagram
//
//  Created by YooJin Hong on 1/13/16.
...
NSString *const LoginViewControllerDidGetAccessTokenNotification = @"LoginViewControllerDidGetTOkenNotification";
...
- (BOOL) webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if ([urlString hasPrefix:[self redirectURI]]) {
        ...
        NSRange rangeOfAccessToekParameter = [urlString rangeOfString:@"access_token="];
        NSUInteger indexOfTokenStarting = rangeOfAccessToekParameter.location + rangeOfAccessToekParameter.length;
